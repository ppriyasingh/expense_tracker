		...
		<section id="body" class="width">
			...
			<nav id="secnav">
  				<ul>
								...
								<li class="selected-item"><a href="#">Food</a></li>
			...
			<section id="content" class="column-right">			
				<h3>Food Expenses</h3>
				<fieldset>
					<legend>Add Food Expenditure</legend>
					<form action="#" method="post">
						<p><label>Date:</label><input type="date" name="Date" required="required" /></p>		
						<p><label>Expenditure:</label><input type="number_format" name="Food" required="required" pattern="[0-9]+"/><br /></p>
			...
			<?php //INSERTION
				if(isset($_POST['submit']))
				{
					...
					if($flag==1)
					{
						...
						SET Food= ($oldFood+$Food),total=($oldTotal+$Food)
						WHERE date='$Date'"; 
						mysqli_query($con, $query);
					}
					else
					{	
						$query = "INSERT INTO expenses(date,Food,total)  
						VALUES('$Date','$Food','$Food')"; 
						mysqli_query($con, $query);
					}
				}
			?>
