...
<body>
		<section id="body" class="width">
			...
			<nav id="secnav">
  				<ul>
                            	<li ><a href="index.php">All Categories</a></li>
                           		<li class="selected-item"><a href="#">Grocery</a></li>
			...
			<section id="content" class="column-right">			
				...
				<fieldset>
					<legend>Add Grocery Expenditure</legend>
					<form action="#" method="post">
						<p><label>Date:</label><input type="date" name="Date" required="required" /></p>		
						<p><label>Expenditure:</label><input type="number_format" name="Grocery" required="required" pattern="[0-9]+"/><br /></p>
			...
			<?php //INSERTION
				if(isset($_POST['submit']))
				{
					...
					if($flag==1)
					{
						...
						SET Grocery= ($oldGrocery+$Grocery),total=($oldTotal+$Grocery)
						WHERE date='$Date'"; 
						mysqli_query($con, $query);
					}
					else
					{	
						$query = "INSERT INTO expenses(date,Grocery,total)  
						VALUES('$Date','$Grocery','$Grocery')"; 
						mysqli_query($con, $query);
					}
				}
			?>
