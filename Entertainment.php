...
<body>
		<section id="body" class="width">
			...
			<nav id="secnav">
  				<ul>
                            	<li ><a href="index.php">All Categories</a></li>
                           		...
                           		<li class="selected-item"><a href="#">Entertainment</a></li>
			...
			<section id="content" class="column-right">			
				...
				<fieldset>
					<legend>Add Entertainment Expenditure</legend>
					<form action="#" method="post">
						<p><label>Date:</label><input type="date" name="Date" required="required" /></p>		
						<p><label>Expenditure:</label><input type="number_format" name="Entertainment" required="required" pattern="[0-9]+"/><br /></p>
			...
			<?php //INSERTION
				if(isset($_POST['submit']))
				{
					...
					while($row1 = mysqli_fetch_assoc($result1))
					{
						...
						{
							$flag=1;
							$oldEntertainment=$Entertainment;
							$oldTotal=$total;
							break;
						}	
					}
					...
					if($flag==1)
					{
						...
						SET Entertainment= ($oldEntertainment+$Entertainment),total=($oldTotal+$Entertainment)
						WHERE date='$Date'"; 
						mysqli_query($con, $query);
					}
					else
					{	
						$query = "INSERT INTO expenses(date,Entertainment,total)  
						VALUES('$Date','$Entertainment','$Entertainment')"; 
						mysqli_query($con, $query);
					}
				}
			?>
