		...
		<section id="body" class="width">
			...
			<nav id="secnav">
  				<ul>
								...
								<li class="selected-item"><a href="#">Vehicle</a></li>
			...
			<section id="content" class="column-right">			
				...
				<fieldset>
					<legend>Add Vehicle Expenditure</legend>
					<form action="#" method="post">
						<p><label>Date:</label><input type="date" name="Date" required="required" /></p>		
						<p><label>Expenditure:</label><input type="number_format" name="Vehicle" required="required" pattern="[0-9]+"/><br /></p>
			...
			<?php //INSERTION
				if(isset($_POST['submit']))
				{
					...
					if($flag==1)
					{
						...
						SET Vehicle= ($oldVehicle+$Vehicle),total=($oldTotal+$Vehicle)
						WHERE date='$Date'"; 
						mysqli_query($con, $query);
					}
					else
					{	
						$query = "INSERT INTO expenses(date,Vehicle,total)  
						VALUES('$Date','$Vehicle','$Vehicle')"; 
						mysqli_query($con, $query);
					}
				}
			?>
